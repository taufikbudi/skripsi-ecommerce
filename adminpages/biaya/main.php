	...
	<div class="">
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2><small>Data Kota Kirim</small></h2>
					...
					<div class="x_content">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>biaya/form_edit.php?id_kota_kirim=<?php echo $data['id_kota_kirim'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>biaya/hapus.php?id_kota_kirim=<?php echo $data['id_kota_kirim'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>biaya/form_tambah.php">
