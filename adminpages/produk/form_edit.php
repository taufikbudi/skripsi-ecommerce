		  ...
		  <input type="hidden" name="id_produk" value="<?php echo $dataProduk['id_produk'];?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-2">
                          <input type="text" id="first-name" name="stok" class="form-control col-md-7 col-xs-12" value="<?php echo $dataProduk['stok']; ?>" >
                        </div>
                      </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                        <?php if($dataProduk['slide']=='Y'){?>
                        <div class="radio">
                        <label><input type="radio" id="first-name" name="slide" required="required" value="Y" checked>Ya
                        </label>                          
                        </div>
                        <div class="radio">
                        ...
                        <div class="radio">
                        <label><input type="radio" id="first-name" name="slide" required="required" value="N" checked>Tidak
                        </label>                          
                        </div>
                        <?php } ?>
                        </div>
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                        <?php if($dataProduk['rekomendasi']=='Y'){?>
                        <div class="radio">
                        <label><input type="radio" id="first-name" name="rekomendasi" required="required" value="Y" checked>Ya
                        </label>                          
                        </div>
                        <div class="radio">
                        ...
                        <div class="radio">
                        <label><input type="radio" id="first-name" name="rekomendasi" required="required" value="N" checked>Tidak
                        </label>                          
                        </div>
                        <?php } ?>
                        </div>
